...
// He wants me to produce a report for him that list only the companies that have placed an order for 
//more than nine thousand dollars."
// const bigSpenders = businesses.filter(business => {
//   return business.orders.find(num => num > 9000)
// })

// const spender = businesses.forEach(business => )
// console.log(bigSpendersArray);
// const container = document.getElementById('container');
// const bigSpendersArray = [];

// // Array to contain all the big spenders
// const bigSpenders = businesses.filter(business.orders => {
//   return business.orders.find(num => num > 9000);
// })
// console.log(bigSpendersArray);
